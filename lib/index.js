...
const Secp256k1Signature2019 = require('ecdsa-secp256k1-signature-2019');
...
if(supportedSuites.includes('Secp256k1Signature2019')) {
  suite.push(new Secp256k1Signature2019());
}
